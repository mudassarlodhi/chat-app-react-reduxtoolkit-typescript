...
export default function AsideNavTab({ user }: IAsideNavTabProps){
  ...
  return (
    <NavLink to={userId} className={({ isActive })=>`flex items-center mb-5 px-4 py-2 text-gray-700 
        rounded-md hover:text-gray-700 ${isActive ? activeTabClass : nonActiveTabClass}` }>
      <svg
        className="w-5 h-5"
        viewBox="0 0 24 24"
        fill="none"
      ...
      >
        <path
          d="M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 
                    4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z"
          stroke="currentColor"
          strokeWidth="2"
          strokeLinecap="round"

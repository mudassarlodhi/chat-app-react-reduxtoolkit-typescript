...
export default function ChatMessage({isCurrentUserMessage , message, userName, dateTime}: IChatMessageProps){
    ...
    return (
        <>
            <div className={'block p-2 mb-2 lg:w-1/2 md:min-w-[50%] sm:w-full rounded-lg border border-gray-200 shadow-md '+containerClasses.join(' ')}>
                <div className='flex items-center justify-between'>
                    <h5 className={'mb-1 text-md font-medium tracking-tight '+headersTextColorClass}>{ userName }</h5>

...
const initialMessageState: MessageState = [{
  ...
  text: `Here are the biggest enterprise technology acquisitions of 2021 so far, 
...
},
{
  messageId: '123459',
  usersKey: 'user1_user2',
  text: `Response to Here are the biggest enterprise technology acquisitions of 2021 so far, 
    in reverse chronological order`,
  from: 'user2',
  fromUserName: 'User 2',
  to: 'user1',
...
const defaultMessageState = messageAdapter.addMany(
...
export const messageSlice = createSlice({
  ...
  reducers: {
    ...
    deleteChatHistoryForTheUser: (state, { payload: userId }) => {
      const removedChats = messageSelectors.selectAll(state)
